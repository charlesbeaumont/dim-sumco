...
// header("Link: </wp-content/themes/dim-sumco/css/style.css>; rel=preload; as=style", false);
// header("Link: </wp-content/themes/dim-sumco/js/app.js>; rel=preload; as=script", false);
?><!doctype html>
...
<div class="wrapper">
    ...
    <header class="c-header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
        ...
        <section class="o-section u-text-xlarge">
            ...
            <div class="o-section__border -center">
                <div class="o-section__border-inner">
                    <a href="<?php echo esc_url( home_url() ); ?>" rel="home" class="c-logo <?php if ( is_singular( 'case' ) ) : ?>-white<?php endif; ?>">
