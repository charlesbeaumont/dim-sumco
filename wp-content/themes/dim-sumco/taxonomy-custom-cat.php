			...
			<article <?php post_class( 'article-entry clearfix' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
				...
				<header class="article-entry__header">
					...
					<p class="entry-meta"><?php
						printf( __( 'Posted <time class="updated" datetime="%1$s" itemprop="datePublished">%2$s</time> by <span class="author">%3$s</span> <span class="amp">&</span> filed under %4$s.', 'dim-sumco' ), get_the_time( 'Y-m-j' ), get_the_time( __( 'F jS, Y', 'dim-sumco' ) ), hummer_get_the_author_posts_link(), get_the_term_list( get_the_ID(), 'custom_cat', "", ", ", "" ) );
					?></p>
				</header>
